...
THREE.Matrix3.prototype = {constructor : THREE.Matrix3, multiplyVector3 : function (a) {
    ...
    var b = a.elements, a = b[10] * b[5] - b[6] * b[9], c = -b[10] * b[1] + b[2] * b[9], d = b[6] * b[1] - b[2] * b[5], e = -b[10] *
        b[4] + b[6] * b[8], f = b[10] * b[0] - b[2] * b[8], g = -b[6] * b[0] + b[2] * b[4], h = b[9] * b[4] - b[5] * b[8], i = -b[9] * b[0] + b[1] * b[8], j = b[5] * b[0] - b[1] * b[4], b = b[0] * a + b[1] * e + b[2] * h;
...
THREE.Matrix4.prototype = {constructor : THREE.Matrix4, set : function (a, b, c, d, e, f, g, h, i, j, l, m, n, p, o, s) {
    var t = this.elements;
    t[0] = a;
    t[4] = b;
    t[8] = c;
    ...
    var c = a.elements, d = b.elements, e = this.elements, f = c[0], g = c[4], h = c[8], i = c[12], j = c[1], l = c[5], m = c[9], n = c[13], p = c[2], o = c[6], s = c[10], t = c[14], r = c[3], z = c[7], w = c[11], c = c[15], q = d[0], E = d[4], A = d[8],
        v = d[12], u = d[1], D = d[5], C = d[9], G = d[13], P = d[2], B = d[6], K = d[10], H = d[14], I = d[3], N = d[7], O = d[11], d = d[15];
    e[0] = f * q + g * u + h * P + i * I;
    e[4] = f * E + g * D + h * B + i * N;
    e[8] = f * A + g * C + h * K + i * O;
    ...
    var a =
        this.elements, b = a[0], c = a[4], d = a[8], e = a[12], f = a[1], g = a[5], h = a[9], i = a[13], j = a[2], l = a[6], m = a[10], n = a[14], p = a[3], o = a[7], s = a[11], a = a[15];
    ...
    var b =
        this.elements, c = a.elements, d = c[0], e = c[4], f = c[8], g = c[12], h = c[1], i = c[5], j = c[9], l = c[13], m = c[2], n = c[6], p = c[10], o = c[14], s = c[3], t = c[7], r = c[11], c = c[15];
    ...
    var d = a.x, e = a.y, f = a.z,
        g = Math.sqrt(d * d + e * e + f * f), d = d / g, e = e / g, f = f / g, g = d * d, h = e * e, i = f * f, j = Math.cos(b), l = Math.sin(b), m = 1 - j, n = d * e * m, p = d * f * m, m = e * f * m, d = d * l, o = e * l, l = f * l, f = g + (1 - g) * j, g = n + l, e = p - o, n = n - l, h = h + (1 - h) * j, l = m + d, p = p + o, m = m - d, i = i + (1 - i) * j, j = c[0], d = c[1], o = c[2], s = c[3], t = c[4], r = c[5], z = c[6], w = c[7], q = c[8], E = c[9], A = c[10], v = c[11];
    c[0] = f * j + g * t + e * q;
    c[1] = f * d + g * r + e * E;
    c[2] = f * o + g * z + e * A;
    c[3] = f * s + g * w + e * v;
...
THREE.Frustum.prototype.setFromMatrix = function (a) {
    var b = this.planes, c = a.elements, a = c[0], d = c[1], e = c[2], f = c[3], g = c[4], h = c[5], i = c[6], j = c[7], l = c[8], m = c[9], n = c[10], p = c[11], o = c[12], s = c[13], t = c[14], c = c[15];
...
(function (a) {
    ...
    var f = new a.Vector3, g = new a.Matrix4, h = function (a, b) {
            ...
            l.sub(a,
                b);
            var a = i.dot(i), b = i.dot(j), c = i.dot(l), e = j.dot(j), d = j.dot(l), f = 1 / (a * e - b * b), e = (e * c - b * d) * f, a = (a * d - b * c) * f;
            ...
            if (h instanceof a.Particle) {
                ...
                var o = h.geometry.boundingSphere.radius * h.matrixWorld.getMaxScaleOnAxis(), l = m(i.origin, i.direction, h.matrixWorld.getPosition());
                if (l > o)return j;
                var o = h.geometry,
                    p = o.vertices, E = h.material instanceof a.MeshFaceMaterial, A = !0 === E ? h.material.materials : null, l = h.material.side, v, u, D, C = i.precision;
...
THREE.Projector = function () {
    ...
    var e, f, g = [], h = 0, i, j, l = [], m = 0, n, p, o = [], s = 0, t, r = [], z = 0, w, q, E = [], A = 0, v, u, D = [], C = 0, G = {objects : [], sprites : [], lights : [], elements : []}, P = new THREE.Vector3, B = new THREE.Vector4, K = new THREE.Matrix4, H = new THREE.Matrix4, I = new THREE.Matrix3, N = new THREE.Frustum, O = new THREE.Vector4, R = new THREE.Vector4;
...
THREE.Quaternion.prototype = {constructor : THREE.Quaternion, set : function (a, b, c, d) {
    ...
    b || (b = a);
    var c = a.x, d = a.y, e = a.z, f = this.x, g = this.y, h = this.z, i = this.w, j = i * c + g * e - h * d, l = i * d + h * c - f * e, m = i * e + f * d - g * c, c = -f * c - g * d - h * e;
    b.x = j * i + c * -f + l * -h - m * -g;
    b.y = l * i + c * -g + m * -f - j * -h;
    b.z = m * i + c * -h + j * -g - l * -f;
    return b
...
THREE.Geometry.prototype = {constructor : THREE.Geometry, applyMatrix : function (a) {
    ...
    if (a) {
        var f, g, h, i = new THREE.Vector3, j = new THREE.Vector3, l = new THREE.Vector3, m = new THREE.Vector3, n = new THREE.Vector3;
        b = 0;
    ...
    computeMorphNormals : function () {
        ...
        for (b = this.morphTargets.length; a <
            ...
            if (!this.morphNormals[a]) {
                ...
                c = 0;
                for (d = this.faces.length; c < d; c++)e = this.faces[c], i = new THREE.Vector3, j = e instanceof THREE.Face3 ? {a : new THREE.Vector3, b : new THREE.Vector3, c : new THREE.Vector3} : {a : new THREE.Vector3, b : new THREE.Vector3, c : new THREE.Vector3, d : new THREE.Vector3}, g.push(i), h.push(j)
            }
        ...
        var b, c, d, e, f, g, h, i, j, l, m, n, p, o, s, t, r, z,
            w, q, E, A, v, u, D = [], C = [], G = new THREE.Vector3, P = new THREE.Vector3, B = new THREE.Vector3, K = new THREE.Vector3, H = new THREE.Vector3;
        b = 0;
...
THREE.BufferGeometry.prototype = {constructor : THREE.BufferGeometry, applyMatrix : function (a) {
    ...
    if (this.attributes.position && this.attributes.index) {
        ...
        var e = this.offsets, f = this.attributes.index.array, g = this.attributes.position.array, h = this.attributes.normal.array, i, j, l, m, n, p, o = new THREE.Vector3, s = new THREE.Vector3, t = new THREE.Vector3, r = new THREE.Vector3, z = new THREE.Vector3;
        c = 0;
    ...
    if (void 0 === this.attributes.index || void 0 === this.attributes.position || void 0 === this.attributes.normal || void 0 === this.attributes.uv)console.warn("Missing required attributes (index, position, normal or uv) in BufferGeometry.computeTangents()"); else {
        ...
        var l, m, n, p, o, s, t, r, z, w, q, E, A, v, u, f = new THREE.Vector3, g = new THREE.Vector3, D, C, G, P, B, K, H, I = this.offsets;
        G = 0;
...
THREE.Loader.prototype = {constructor : THREE.Loader, crossOrigin : "anonymous", addStatusElement : function () {
    ...
    var g = this, h = "MeshLambertMaterial", i = {color : 15658734, opacity : 1, map : null,
    ...
    a.mapNormal ? (h = THREE.ShaderUtils.lib.normal, j = THREE.UniformsUtils.clone(h.uniforms), j.tNormal.value = i.normalMap, a.mapNormalFactor && j.uNormalScale.value.set(a.mapNormalFactor, a.mapNormalFactor), i.map && (j.tDiffuse.value = i.map, j.enableDiffuse.value = !0), i.specularMap && (j.tSpecular.value = i.specularMap, j.enableSpecular.value = !0), i.lightMap && (j.tAO.value = i.lightMap, j.enableAO.value = !0), j.uDiffuseColor.value.setHex(i.color),
        j.uSpecularColor.value.setHex(i.specular), j.uAmbientColor.value.setHex(i.ambient), j.uShininess.value = i.shininess, void 0 !== i.opacity && (j.uOpacity.value = i.opacity), i = new THREE.ShaderMaterial({fragmentShader : h.fragmentShader, vertexShader : h.vertexShader, uniforms : j, lights : !0, fog : !0})) : i = new THREE[h](i);
...
THREE.BinaryLoader.prototype.loadAjaxBuffers = function (a, b, c, d, e) {
    ...
    f.onreadystatechange = function () {
        ...
        } else console.error("THREE.BinaryLoader: Couldn't load [" + g + "] [" + f.status + "]"); else 3 == f.readyState ? e && (0 == h && (h = f.getResponseHeader("Content-Length")), e({total : h, loaded : f.responseText.length})) :
...
THREE.JSONLoader.prototype.createModel = function (a, b, c) {
    var d = new THREE.Geometry, e = void 0 !== a.scale ? 1 / a.scale : 1, f, g, h, i, j, l, m, n, p, o, s, t, r, z, w, q = a.faces;
    o = a.vertices;
...
THREE.SceneLoader.prototype.parse = function (a, b, c) {
    ...
    O = N = 0;
    M = {scene : new THREE.Scene, geometries : {}, face_materials : {}, materials : {}, textures : {}, objects : {}, cameras : {}, lights : {}, fogs : {}, empties : {}};
    ...
    for (s in Q.textures) {
        ...
        if (n.url instanceof Array) {
            ...
            if (n.wrap && (L = {repeat : THREE.RepeatWrapping, mirror : THREE.MirroredRepeatWrapping}, void 0 !== L[n.wrap[0]] && (B.wrapS = L[n.wrap[0]]), void 0 !== L[n.wrap[1]]))B.wrapT = L[n.wrap[1]]
        }
        M.textures[s] = B
    }
        ...
        function z(a, b, c, d, f, g, h, k, i, j, l, n, na) {
            if (!(na instanceof THREE.DataTexture || void 0 === na.image || 0 == na.image.width)) {
                ...
                var m = na.offset.x / na.repeat.x, o = na.offset.y / na.repeat.y,
                    Db = na.image.width * na.repeat.x, p = na.image.height * na.repeat.y, h = (h + m) * Db, k = (1 - k + o) * p, c = c - a, d = d - b, f = f - a, g = g - b, i = (i + m) * Db - h, j = (1 - j + o) * p - k, l = (l + m) * Db - h, n = (1 - n + o) * p - k, m = i * n - l * j;
...
THREE.WebGLRenderer = function (a) {
    ...
    function d(a, b) {
        var c = b.geometry, d = a.faces3, h = a.faces4, i = 3 * d.length + 4 * h.length, j = 1 * d.length + 2 * h.length, h = 3 * d.length + 4 * h.length, d = e(b, a), l = g(d), n = f(d), m = d.vertexColors ? d.vertexColors : !1;
    ...
    var a = a || {}, I = void 0 !== a.canvas ? a.canvas : document.createElement("canvas"), N = void 0 !== a.precision ? a.precision : "highp", O = void 0 !== a.alpha ? a.alpha : !0, R = void 0 !== a.premultipliedAlpha ? a.premultipliedAlpha : !0, ga = void 0 !== a.antialias ? a.antialias : !1, M = void 0 !== a.stencil ? a.stencil : !0, J = void 0 !== a.preserveDrawingBuffer ? a.preserveDrawingBuffer : !1, Q = void 0 !== a.clearColor ? new THREE.Color(a.clearColor) : new THREE.Color(0), Z = void 0 !== a.clearAlpha ? a.clearAlpha : 0;
    this.domElement =
        I;
    this.context = null;
    ...
    var L = this, oa = [], X = 0, fa = null, ca = null, Y = -1, ba = null, aa = null, ia = 0, Aa = 0, Na = -1, Ja = -1, ma = -1, sa = -1, Ea = -1, rb = -1, ib = -1, ob = -1, jb = null, Bb = null, Cb = null, Wa = null, Sa = 0, Ka = 0, kb = 0, Oa = 0, lb = 0, ab = 0, va = new THREE.Frustum, eb = new THREE.Matrix4, pb = new THREE.Matrix4, bb = new THREE.Vector4, xa = new THREE.Vector3, mb = !0, sb = {ambient : [0, 0, 0], directional : {length : 0, colors : [], positions : []}, point : {length : 0, colors : [], positions : [], distances : []}, spot : {length : 0,
        colors : [], positions : [], distances : [], directions : [], anglesCos : [], exponents : []}, hemi : {length : 0, skyColors : [], groundColors : [], positions : []}}, k, zb, qb;
    try {
        if (!(k = I.getContext("experimental-webgl", {alpha : O, premultipliedAlpha : R, antialias : ga, stencil : M, preserveDrawingBuffer : J})))throw"Error creating WebGL context.";
    } catch (Pc) {
        console.error(Pc)
    }
        ...
        for (; a.__objectsAdded.length;) {
            ...
            if (!b.__webglInit)if (b.__webglInit = !0, b._modelViewMatrix = new THREE.Matrix4, b._normalMatrix = new THREE.Matrix3, b instanceof THREE.Mesh)if (m = b.geometry, o = b.material, m instanceof THREE.Geometry) {
                if (void 0 === m.geometryGroups) {
                    var q = m, u = void 0, v = void 0, A = void 0, B = void 0, C = void 0, D = void 0, E = void 0, G = {}, H = q.morphTargets.length, I = q.morphNormals.length, X = o instanceof THREE.MeshFaceMaterial;
                    q.geometryGroups = {};
                    u = 0;
            ...
            if (!b.__webglActive) {
                if (b instanceof THREE.Mesh)if (m = b.geometry, m instanceof THREE.BufferGeometry)s(l.__webglObjects, m, b); else for (n in m.geometryGroups)p = m.geometryGroups[n], s(l.__webglObjects, p, b); else b instanceof THREE.Ribbon || b instanceof THREE.Line || b instanceof THREE.ParticleSystem ? (m = b.geometry, s(l.__webglObjects, m, b)) : b instanceof THREE.ImmediateRenderObject ||
                    b.immediateRenderCallback ? l.__webglObjectsImmediate.push({object : b, opaque : null, transparent : null}) : b instanceof THREE.Sprite ? l.__webglSprites.push(b) : b instanceof THREE.LensFlare && l.__webglFlares.push(b);
                b.__webglActive = !0
            }
            ...
            if (qa instanceof THREE.Mesh)if (T instanceof THREE.BufferGeometry)(T.verticesNeedUpdate || T.elementsNeedUpdate || T.uvsNeedUpdate || T.normalsNeedUpdate || T.colorsNeedUpdate ||
                ...
                for (var Ka = 0, Oa = T.geometryGroupsList.length; Ka < Oa; Ka++)if (Ja = T.geometryGroupsList[Ka], ma = e(qa, Ja), T.buffersNeedUpdate && d(Ja, qa), va = ma.attributes && t(ma), T.verticesNeedUpdate || T.morphTargetsNeedUpdate || T.elementsNeedUpdate || T.uvsNeedUpdate || T.normalsNeedUpdate || T.colorsNeedUpdate || T.tangentsNeedUpdate || va) {
                    ...
                    if (ra.__inittedArrays) {
                        var mb = f(Wa), rb = Wa.vertexColors ? Wa.vertexColors : !1, ob = g(Wa), lb = mb === THREE.SmoothShading, F = void 0, $ = void 0, ab = void 0, S = void 0, eb = void 0, bb = void 0, Eb = void 0, pb = void 0, Vb = void 0, jb = void 0, kb = void 0, U = void 0, V = void 0, W = void 0, pa = void 0, Fb = void 0, Gb = void 0, Hb = void 0, qb = void 0, Ib = void 0, Jb = void 0, Kb = void 0, sb = void 0, Lb = void 0, Mb = void 0, Nb = void 0, zb = void 0, Ob = void 0, Pb = void 0, Qb = void 0, Bb = void 0, Rb = void 0, Sb = void 0, Tb = void 0, Cb = void 0,
                            ...
                            oc = fb.uvsNeedUpdate, Pc = fb.normalsNeedUpdate, Qc = fb.tangentsNeedUpdate, hd = fb.colorsNeedUpdate, id = fb.morphTargetsNeedUpdate, ec = fb.vertices, ta = ra.faces3, ua = ra.faces4, $a = fb.faces, Vc = fb.faceVertexUvs[0], Wc = fb.faceVertexUvs[1], fc = fb.skinIndices, cc = fb.skinWeights, dc = fb.morphTargets, Ac = fb.morphNormals;
                ...
                if (T.verticesNeedUpdate || T.colorsNeedUpdate || T.lineDistancesNeedUpdate || va) {
                    var yb = T, Jc = k.DYNAMIC_DRAW, uc = void 0, vc = void 0, wc = void 0, Kc = void 0, Ia = void 0, Lc = void 0, cd = yb.vertices, dd = yb.colors,
                        ed = yb.lineDistances, od = cd.length, pd = dd.length, qd = ed.length, Mc = yb.__vertexArray, Nc = yb.__colorArray, fd = yb.__lineDistanceArray, rd = yb.colorsNeedUpdate, sd = yb.lineDistancesNeedUpdate, Yc = yb.__webglCustomAttributesList, Oc = void 0, gd = void 0, Ya = void 0, nc = void 0, hb = void 0, Da = void 0;
    ...
    this.initMaterial = function (a, b, c, d) {
        ...
        a:{
            ...
            b = a.attributes;
            p = a.defines;
            var c = {map : !!a.map, envMap : !!a.envMap, lightMap : !!a.lightMap, bumpMap : !!a.bumpMap, normalMap : !!a.normalMap, specularMap : !!a.specularMap, vertexColors : a.vertexColors, fog : c, useFog : a.fog,
                ...
                shadowMapDebug : this.shadowMapDebug, shadowMapCascade : this.shadowMapCascade, alphaTest : a.alphaTest, metal : a.metal, perPixel : a.perPixel, wrapAround : a.wrapAround, doubleSided : a.side === THREE.DoubleSide, flipSided : a.side === THREE.BackSide}, t, u, v, d = [];
    ...
    this.setTexture =
        function (a, b) {
            if (a.needsUpdate) {
                ...
                var c = a.image, d = 0 === (c.width & c.width - 1) && 0 === (c.height & c.height - 1), e = H(a.format), f = H(a.type);
                P(k.TEXTURE_2D, a, d);
...
THREE.GeometryUtils = {merge : function (a, b) {
    var c, d, e = a.vertices.length, f = b instanceof THREE.Mesh ? b.geometry : b, g = a.vertices, h = f.vertices, i = a.faces, j = f.faces, l = a.faceVertexUvs[0], f = f.faceVertexUvs[0];
...
THREE.ImageUtils = {crossOrigin : "anonymous", loadTexture : function (a, b, c, d) {
    ...
    for (var h = g.getImageData(0, 0, d, e).data, i = g.createImageData(d, e), j = i.data, l = 0; l < d; l++)for (var m = 0; m < e; m++) {
        var n =
                0 > m - 1 ? 0 : m - 1, p = m + 1 > e - 1 ? e - 1 : m + 1, o = 0 > l - 1 ? 0 : l - 1, s = l + 1 > d - 1 ? d - 1 : l + 1, t = [], r = [0, 0, h[4 * (m * d + l)] / 255 * b];
        ...
        o = t.length;
        for (p = 0; p < o; p++) {
            var s = t[p], z = t[(p + 1) % o], s = [s[0] - r[0], s[1] - r[1], s[2] - r[2]], z = [z[0] - r[0], z[1] - r[1], z[2] - r[2]];
            n.push(c([s[1] *
        ...
        for (j = e - 1; 2 < e;) {
            ...
            a:{
                ...
                var p = i, o = j, s = l, t = e, r = g, z = void 0, w = void 0, q = void 0, E = void 0, A = void 0,
                    v = void 0, u = void 0, D = void 0, C = void 0, w = n[r[p]].x, q = n[r[p]].y, E = n[r[o]].x, A = n[r[o]].y, v = n[r[s]].x, u = n[r[s]].y;
                if (1E-10 > (E - w) * (u - q) - (A - q) * (v - w))n = !1; else {
                    for (z = 0; z < t; z++)if (!(z == p || z == o || z == s)) {
                        var D = n[r[z]].x, C = n[r[z]].y, G = void 0, P = void 0, B = void 0, K = void 0, H = void 0, I = void 0, N = void 0, O = void 0, R = void 0, ga = void 0, M = void 0, J = void 0, G = B = H = void 0, G = v - E, P = u - A, B = w - v, K = q - u, H = E - w, I = A - q, N = D - w, O = C - q, R = D - E, ga = C - A, M = D - v, J = C - u, G = G * ga - P * R, H = H * O - I * N, B = B * J - K * M;
                        if (0 <= G && 0 <= B && 0 <= H) {
                            n = !1;
                            break a
                        }
...
THREE.CylinderGeometry = function (a, b, c, d, e, f) {
    ...
    for (h = 0; h < d; h++) {
        ...
        for (i = 0; i < e; i++) {
            var p = j[i][h], o = j[i + 1][h], s = j[i + 1][h + 1], t = j[i][h + 1], r = m.clone(), z = m.clone(), w = n.clone(), q = n.clone(), E = l[i][h].clone(), A = l[i + 1][h].clone(), v = l[i + 1][h + 1].clone(), u = l[i][h + 1].clone();
...
THREE.ExtrudeGeometry.prototype.addShape = function (a, b) {
    ...
    function e(c, d) {
        ...
        for (J = c.length; 0 <= --J;) {
            ...
            for (var g = 0, h = n + 2 * l, g = 0; g < h; g++) {
                var i = R * g, j = R * (g + 1), m = d + e + i, i = d + f + i, o = d + f + j, j = d + e + j, p = c, s = g, q = h, t = e, u = f, m = m + G, i = i + G, o = o + G, j = j + G;
    ...
    var h = void 0 !==
        b.amount ? b.amount : 100, i = void 0 !== b.bevelThickness ? b.bevelThickness : 6, j = void 0 !== b.bevelSize ? b.bevelSize : i - 2, l = void 0 !== b.bevelSegments ? b.bevelSegments : 3, m = void 0 !== b.bevelEnabled ? b.bevelEnabled : !0, n = void 0 !== b.steps ? b.steps : 1, p = b.extrudePath, o, s = !1, t = b.material, r = b.extrudeMaterial, z = void 0 !== b.UVGenerator ? b.UVGenerator : THREE.ExtrudeGeometry.WorldUVGenerator, w, q, E, A;
    p && (o = p.getSpacedPoints(n), s = !0, m = !1, w = void 0 !== b.frames ? b.frames : new THREE.TubeGeometry.FrenetFrames(p, n, !1), q = new THREE.Vector3, E = new THREE.Vector3,
        A = new THREE.Vector3);
    m || (j = i = l = 0);
    var v, u, D, C = this, G = this.vertices.length, p = a.extractPoints(), P = p.shape, p = p.holes, B = !THREE.Shape.Utils.isClockWise(P);
    if (B) {
        P = P.reverse();
        u = 0;
...
THREE.TubeGeometry = function (a, b, c, d, e, f) {
    ...
    this.grid = [];
    var g, h, f = this.segments + 1, i, j, l, m = new THREE.Vector3, n, p, o, b = new THREE.TubeGeometry.FrenetFrames(a, b, e);
    n = b.tangents;
    p = b.normals;
    o = b.binormals;
    this.tangents = n;
...
THREE.DirectionalLightHelper = function (a, b, c) {
    ...
    this.color.g *= d;
    this.color.b *= d;
    var d = this.color.getHex(), e = new THREE.SphereGeometry(b, 16, 8), f = new THREE.AsteriskGeometry(1.25 * b, 2.25 * b), g = new THREE.MeshBasicMaterial({color : d, fog : !1}), h = new THREE.LineBasicMaterial({color : d, fog : !1});
...
THREE.HemisphereLightHelper = function (a, b, c) {
    ...
    for (var d = this.groundColor.getHex(), f = new THREE.SphereGeometry(b, 16, 8, 0, 2 * Math.PI, 0, 0.5 * Math.PI), g = new THREE.SphereGeometry(b, 16, 8, 0, 2 * Math.PI, 0.5 *
        Math.PI, Math.PI), h = new THREE.MeshBasicMaterial({color : e, fog : !1}), i = new THREE.MeshBasicMaterial({color : d, fog : !1}), j = 0, l = f.faces.length; j < l; j++)f.faces[j].materialIndex = 0;
    j = 0;
...
THREE.PointLightHelper = function (a, b) {
    ...
    this.color.g *= c;
    this.color.b *= c;
    var d = this.color.getHex(), c = new THREE.SphereGeometry(b, 16, 8), e = new THREE.AsteriskGeometry(1.25 * b, 2.25 * b), f = new THREE.IcosahedronGeometry(1, 2), g = new THREE.MeshBasicMaterial({color : d, fog : !1}), h = new THREE.LineBasicMaterial({color : d, fog : !1}), d = new THREE.MeshBasicMaterial({color : d, fog : !1, wireframe : !0,
...
THREE.SpotLightHelper = function (a, b, c) {
    ...
    this.color.g *= d;
    this.color.b *= d;
    var d = this.color.getHex(), e = new THREE.SphereGeometry(b, 16, 8), f = new THREE.AsteriskGeometry(1.25 * b, 2.25 * b), g = new THREE.CylinderGeometry(1E-4, 1, 1, 8, 1, !0), h = new THREE.Matrix4;
    h.rotateX(-Math.PI / 2);
    h.translate(new THREE.Vector3(0,
        -0.5, 0));
    g.applyMatrix(h);
    var i = new THREE.MeshBasicMaterial({color : d, fog : !1}), h = new THREE.LineBasicMaterial({color : d, fog : !1}), j = new THREE.MeshBasicMaterial({color : d, fog : !1, wireframe : !0, opacity : 0.3, transparent : !0});
    this.lightArrow = new THREE.ArrowHelper(this.direction, null, c, d);
    ...
    this.lightSphere.properties.gizmoRoot = this;
    this.targetSphere = null;
    a.target.properties.targetInverse && (b = new THREE.SphereGeometry(b, 8, 4), f = new THREE.MeshBasicMaterial({color : d,
...
THREE.SubdivisionModifier.prototype.smooth = function (a) {
    ...
    var h = [],
        i = [], j = [], l = this, m = THREE.GeometryUtils.orderedKey, n = THREE.GeometryUtils.computeEdgeFaces, p = a.vertices, o = a.faces, s = p.length, h = p.concat(), t = [], r = {}, z = {}, w = {}, q, E, A, v, u, D = a.faceVertexUvs[0], C;
    ...
    v = ["123", "12", "2", "23"];
    P = ["123", "23", "3", "31"];
    var H = ["123", "31", "1", "12"], I = ["1234", "12", "2", "23"], R = ["1234", "23", "3", "34"], ga = ["1234", "34", "4", "41"], M = ["1234", "41", "1", "12"];
    q = 0;
...
THREE.LensFlarePlugin = function () {
    ...
    this.render = function (a, d, e, r) {
        ...
        if (z) {
            var w = new THREE.Vector3, q = r / e, E = 0.5 * e, A = 0.5 * r, v = 16 / r, u = new THREE.Vector2(v * q, v), D = new THREE.Vector3(1, 1, 0), C = new THREE.Vector2(1, 1), G = n, v = m;
            b.useProgram(l);
...
THREE.ShadowMapPlugin = function () {
    ...
    this.update = function (l, m) {
        ...
        for (p = E.length; n < p; n++) {
            o = E[n];
            o.shadowMap || (o.shadowMap = new THREE.WebGLRenderTarget(o.shadowMapWidth, o.shadowMapHeight, {minFilter : THREE.LinearFilter, magFilter : THREE.LinearFilter, format : THREE.RGBAFormat}), o.shadowMapSize = new THREE.Vector2(o.shadowMapWidth, o.shadowMapHeight), o.shadowMatrix = new THREE.Matrix4);
            if (!o.shadowCamera) {
            ...
            q = l.__webglObjects;
            o = 0;
            for (s = q.length; o < s; o++)if (z = q[o], r = z.object, z.render = !1, r.visible && r.castShadow && (!(r instanceof THREE.Mesh || r instanceof THREE.ParticleSystem) || !r.frustumCulled || g.contains(r)))r._modelViewMatrix.multiply(t.matrixWorldInverse, r.matrixWorld), z.render = !0;
            o = 0;
...
THREE.SpritePlugin = function () {
    ...
    this.init = function (a) {
        ...
        b.bindBuffer(b.ELEMENT_ARRAY_BUFFER, g);
        b.bufferData(b.ELEMENT_ARRAY_BUFFER, e, b.STATIC_DRAW);
        var a = THREE.ShaderSprite.sprite, n = b.createProgram(), p = b.createShader(b.FRAGMENT_SHADER), o = b.createShader(b.VERTEX_SHADER);
...
THREE.DepthPassPlugin = function () {
    ...
    this.init = function (g) {
        ...
        c = new THREE.ShaderMaterial({fragmentShader : g.fragmentShader, vertexShader : g.vertexShader, uniforms : h});
        d = new THREE.ShaderMaterial({fragmentShader : g.fragmentShader, vertexShader : g.vertexShader, uniforms : h, morphTargets : !0});
        e = new THREE.ShaderMaterial({fragmentShader : g.fragmentShader, vertexShader : g.vertexShader,
